	...
	return (
		...
		>
						...
						<FieldGroup>
							...
							<Field>
								...
								<FieldDescription className="text-center">
									...
									<a href={`${import.meta.env.VITE_BASE_URL}/signup`}>
										Sign up
									</a>
								</FieldDescription>
							</Field>
			...
			<FieldDescription className="px-6 text-center">
				...
				<a href={`${import.meta.env.VITE_BASE_URL}/terms-of-service`}>
					Terms of Service
				</a>{" "}
				and{" "}
				<a href={`${import.meta.env.VITE_BASE_URL}/privacy-policy`}>
					Privacy Policy
				</a>
				.
			</FieldDescription>
